...
const LandingHeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen p-4 md:p-16 lg:p-24 max-h-screen flex flex-col-reverse justify-end max-w-7xl mx-auto md:grid md:grid-cols-2">
      {/* Content */}
      <div className="md:flex md:items-center">
        <div className="max-w-md md:pb-16 text-center md:text-left flex flex-col justify-between h-full flex-1 pb-6 gap-4 md:gap-2">
          {/* Logo */}
          <div className="flex flex-col gap-4 md:gap-2">
            ...
            <p className="md:text-sm font-light">
              ...
              Create Artifacts, inscribe your thoughts, and keep them safe in
              your own Prasasti. Download, import, and preserve your knowledge —
              just like an ancient inscription carved in stone.
            </p>
          </div>

          <div className="mt-6 md:flex gap-2 grid grid-cols-2 ">
            <Button
      ...
      <div className="flex items-center justify-center md:justify-end flex-1">
        <Image
          ...
          alt="Inscription Art"
          className="invert md:min-w-[380px] md:max-w-[380px]"
        />
      </div>
    </section>
  );
